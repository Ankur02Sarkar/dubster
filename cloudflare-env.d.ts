/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: e683f465e38376650b6f9682249cb6bd)
// Runtime types generated with workerd@1.20260603.1 2026-06-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXT_PUBLIC_BASE_URL: "https://dubster.app";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_BASE_URL" | "NEXTJS_ENV">> {}
}
